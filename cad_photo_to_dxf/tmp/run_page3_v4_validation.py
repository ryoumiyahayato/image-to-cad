...
from app.image_loader import load_image, pdf_page_size_mm
...
from app.trace_dxf_entities import TracePalette
from app.trace_single_export import export_exact_trace_dxf


SOURCE = Path(r"C:\Users\agcrf\Desktop\环保局主大楼.pdf")
OUTPUT_DIRECTORY = Path(
    r"C:\Users\agcrf\Desktop\image-to-cad\cad_photo_to_dxf"
    r"\validation\scan-artifact-visual-fix-2026-07-28"
)
OUTPUT_DXF = OUTPUT_DIRECTORY / "environment-page-003-ownership-v16.dxf"
OUTPUT_REPORT = OUTPUT_DIRECTORY / "environment-page-003-ownership-v16.report.json"
PAGE_INDEX = 2
PDF_DPI = 290
