# warehouse-source-page-001-072dpi

- Input: `tests/real_regression/assets/sources/warehouse-electrical-vector.pdf`
- Page / DPI: 1 / 72
- FinalStructure: `e8a465890ce09ddb3fdda8cacaaffc8cd11fe0698f48e0c0ca4787be2b93f134`
- OCR candidates: 77
- TEXT eligible / native TEXT: 77 / 77
- Confidence hard rejects: 0
- Invalid geometry rejects: 0
- Hidden source-outline backup candidates / entities: 50 / 471
- Uncertain candidates / entities: 0 / 0
- TRACE_TEXT_SYMBOL entities: 119
- Maximum center / rotation error: 0.0 / 0.0
- Width-factor range: 0.72 to 2.1311586816173973
- Overall: PASS
