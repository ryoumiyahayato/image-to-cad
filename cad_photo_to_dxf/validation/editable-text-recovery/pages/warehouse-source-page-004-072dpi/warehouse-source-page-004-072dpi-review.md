# warehouse-source-page-004-072dpi

- Input: `tests/real_regression/assets/sources/warehouse-electrical-vector.pdf`
- Page / DPI: 4 / 72
- FinalStructure: `ed6dc1ec4175021268e877e877b7d8156773229517eb83a32916a25de38dba4e`
- OCR candidates: 122
- TEXT eligible / native TEXT: 121 / 121
- Confidence hard rejects: 1
- Invalid geometry rejects: 0
- Hidden source-outline backup candidates / entities: 96 / 517
- Uncertain candidates / entities: 1 / 1
- TRACE_TEXT_SYMBOL entities: 427
- Maximum center / rotation error: 0.0 / 0.0
- Width-factor range: 0.72 to 3.6517111853088475
- Overall: PASS
...
- `ocr-069`: `confidence_below_contract` — `核`
