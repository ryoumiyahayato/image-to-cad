# environment-source-page-013-120dpi

- Input: `tests/real_regression/assets/sources/environment-building-scan.pdf`
- Page / DPI: 13 / 120
- FinalStructure: `bb72ac449c5da893430f9a9fe24065297c272d1c7826071d034a88a2b00ea45f`
- OCR candidates: 154
- TEXT eligible / native TEXT: 153 / 153
- Confidence hard rejects: 1
- Invalid geometry rejects: 0
- Hidden source-outline backup candidates / entities: 132 / 1088
- Uncertain candidates / entities: 1 / 3
- TRACE_TEXT_SYMBOL entities: 1116
- Maximum center / rotation error: 0.0 / 0.0
- Width-factor range: 0.72 to 3.753086419753086
- Overall: PASS
...
- `ocr-062`: `confidence_below_contract` — `狐`
